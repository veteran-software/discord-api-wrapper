...
const (
	...
	getApplicationRoleConnectionMetadataRecords    = "%s/applications/%s/role-connections/metadata"
	updateApplicationRoleConnectionMetadataRecords = getApplicationRoleConnectionMetadataRecords
	listAutoModerationRulesForGuild                = "%s/guilds/%s/auto-moderation/rules"
	getAutoModerationRule                          = "%s/guilds/%s/auto-moderation/rules/%s"
	createAutoModerationRule                       = listAutoModerationRulesForGuild
	modifyAutoModerationRule                       = getAutoModerationRule
	deleteAutoModerationRule                       = getAutoModerationRule
)
